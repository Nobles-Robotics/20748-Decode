...
@Autonomous
public class A2ndNewMainAuto extends NextFTCOpMode {
    {
        addComponents(
    ...
    public static final Pose intake1Blue = new Pose(15, 84, Math.toRadians(180));

    public static final Pose intake13C1Blue = new Pose(60, 84, Math.toRadians(180));



    //public static final Pose intakeAlign3Blue = new Pose(45, 38, Math.toRadians(180));
    public static final Pose intake3Blue = new Pose(15, 36, Math.toRadians(180));
    public static final Pose intake3C1Blue = new Pose(60, 36, Math.toRadians(180));
    public static final Pose intake3C2Blue = new Pose(66, 33, Math.toRadians(180));
...
//    Path score2 = new Path(new BezierLine(intake2Blue, scorePose));
    ...
    public void onStartButtonPressed() {
        ...
        if (blue){
            ...
            intake1 = intake1Blue;
            intake1C1 = intake13C1Blue;

            //intakeAlign3 = intakeAlign3Blue;
            intake3 = intake3Blue;
            intake3C1 = intake3C1Blue;
            intake3C2 = intake3C2Blue;
            ...
            intake1C1 = intake13C1Blue.mirror();
            intake3 = intake3Blue.mirror();
            intake3C1 = intake3C1Blue.mirror();
            intake3C2 = intake3C2Blue.mirror();
        ...
        intake1Path = new Path(new BezierCurve(scorePose, intake1C1, intake1));
        score1Path = new Path(new BezierLine(intake1, scorePose));

        intake3Path = new Path(new BezierCurve(scorePose, intake3C1, intake3C2, intake3));
        ...
        intake1Path.setLinearHeadingInterpolation(scorePose.getHeading(), intake1.getHeading());
        score1Path.setLinearHeadingInterpolation(intake1.getHeading(), scorePose.getHeading());

        intake3Path.setLinearHeadingInterpolation(scorePose.getHeading(), intake3.getHeading());
