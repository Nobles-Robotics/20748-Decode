...
//        PhotonCore.enable();
    ...
    @Override public void onStartButtonPressed() {
        ...
        gp1.leftBumper().or(gp2.dpadDown())
        ...
        gp2.rightBumper()
                .whenBecomesTrue(() -> {
                    Outtake.on.schedule();
                    Outtake.setTargetVelocity(2500);
                })
